...
async function migrateCharacter(
  ...
  return {
    ...
    identity: {
      ...
      subclass: asString(legacy.playerSubclass),
      species: asString(legacy.playerRace),
      subrace: asString(legacy.playerSubrace),
      background: asString(legacy.playerBackground),
      playerName: asString(legacy.playerName),
      level,
